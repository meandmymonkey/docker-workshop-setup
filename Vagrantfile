...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "services" do |services|
    services.vm.box_url = "http://static.inputrequired.org/phpnw14/phpnw14-services.box"
    services.vm.box = "phpnw14-services"
  ...
  config.vm.define "playground" do |playground|
    playground.vm.box_url = "http://static.inputrequired.org/phpnw14/phpnw14-playground.box"
    playground.vm.box = "phpnw14-playground"
